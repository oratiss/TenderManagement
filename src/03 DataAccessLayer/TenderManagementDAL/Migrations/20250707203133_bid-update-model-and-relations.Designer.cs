...
namespace TenderManagementDAL.Migrations
{
    ...
    [Migration("20250707203133_bid-update-model-and-relations")]
    partial class bidupdatemodelandrelations
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TenderManagementDAL.Models.Bid", b =>
                {
                    ...
                    b.HasOne("TenderManagementDAL.Models.Tender", "Tender")
                        .WithMany()
                    ...
                    b.HasOne("TenderManagementDAL.Models.Vendor", "Vendor")
                        .WithMany()
